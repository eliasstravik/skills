...
1. Resolve the save file: **client explicitly asked to continue an existing consultation?** → resume it; **otherwise?** → create `~/.consultant/<slug>/` with a fresh `consultation.md`, without checking for or asking about existing consultations.
