...
train and 8 held-out, with implicit positive requests, explicit `/automake`
...
candidate C scored 36/36 train and 24/24 held-out. Its `best_description` is
applied verbatim in `skills/automake/SKILL.md`. The flag
