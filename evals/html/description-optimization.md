...
applied verbatim in `skills/html/SKILL.md`. The flag
...
selected `html`, and every ordinary HTML, UI, browser, email, or code request
avoided it, for 60/60 correct decisions.
...
- `name: html` matches the directory and naming grammar. PASS
...
- YAML parses successfully. The body has 14 lines; the Recipe core has 10
